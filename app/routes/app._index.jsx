...
import { useLoaderData, useNavigate, Form, useActionData, useNavigation, useSubmit, useLocation } from "@remix-run/react";
...
export const handleManualRedirect_MI = (shop, setError_MI) => {
  try {
    if (shop && shop.includes(".myshopify.com")) {
      const storeName_MI = shop.split('.')[0];
      window.open(
        `https://admin.shopify.com/store/${storeName_MI}/themes/current/editor?template=product`,
        '_top'
      );
    } else {
      shopify.toast.show(
        "Could not determine your shop name. Please navigate to your theme editor manually and add blocks."
      );
    }
  } catch (error) {
    setError_MI('Manual redirect failed: ' + error.message);
  }
};
...
export default function Index() {
  ...
  const [error_MI, setError_MI] = useState("");
  ...
  const [isGuideOpen_MI, setIsGuideOpen] = useState(false);
              ...
              <Card>
                <div style={{ textAlign: "center", padding: "2rem" }}>
                  ...
                  <Text as="p" variant="bodyMd" tone="subdued">
                    Please install this app on your Shopify store to get started.
                  </Text>
        ...
        <Layout>
          ...
          {showAccount_MI ? (
                  ...
                  {createdAccount_MI && !isEditing_MI ? (
                    <div style={formContainerStyle}>
                      ...
                      <div style={inputWrapperStyle}>
                        ...
                        <div style={detailItemStyle}>
                          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", flex: 1 }}>
                            <img src="/user.svg" alt="Shop" style={shopImageStyle} />
                      ...
                      <div style={inputWrapperStyle}>
                        ...
                        <div style={detailItemStyle}>
                          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", flex: 1 }}>
                            <img src="/mail.svg" alt="Shop" style={shopImageStyle} />
                            <Text as="span" style={detailStyle}>
                      ...
                      <div style={inputWrapperStyle}>
                        ...
                        <div style={nonEditableDetailItemStyle}>
                         <img src="/lock.svg" alt="Shop" style={shopImageStyle} />
                          <Text as="span" style={detailStyle}>
            ...
            <>
              <Layout.Section>
                <Card padding="0">
                  <img src="/banner.svg" alt="banner" style={{width: "100%",  height: "auto",  objectFit: "cover"}} />
                </Card>
              </Layout.Section>
              <Layout.Section>
              ...
              {createdAccount_MI && (
                <Layout.Section>
                  <Card>
                    <Text as="h3" variant="headingMd" > Get Started with Product Review App </Text>
                    <br/>
                    <div
                      onClick={() => setIsGuideOpen(!isGuideOpen_MI)}
                      style={{
                        cursor: "pointer",
                        display: "flex",
                        alignItems: "center",
                    ...
                    >
                      ...
                      <img
                        src={isGuideOpen_MI ? "/dropup.svg" : "/dropdown.svg"}
                        alt={isGuideOpen_MI ? "Collapse" : "Expand"}
                        style={sectionIconStyle}
                      />
                    </div>
                    {isGuideOpen_MI && (
                      <div style={{ padding: "1rem" }}>
                        <Text as="p" variant="bodyMd" tone="subdued" style={{ marginBottom: "1rem" }}>
                          Follow these steps to set up and display Product Reviews in your store.
                        </Text>
                        <div style={{ marginBottom: "1rem" }}>
                          <Text as="span" variant="bodyMd">
                            First create an account if you haven't already. Then, go to the Configuration page to set up your review settings.
                          </Text>
                          <div style={{ marginTop: "0.5rem", display: "flex", gap: "16px" }}>
                            <Button
                              onClick={() => handleManualRedirect_MI(shop, setError_MI)}
                              variant="primary"
                              disabled={isLoading}
                              style={buttonStyle}
                            >
                            ...
                            <Button
                              onClick={() => navigate(`/app/star-rating-settings?shop=${encodeURIComponent(shop)}`)}
                              variant="primary"
                              disabled={isLoading}
                              style={buttonStyle}
                            >
                        ...
                        <div>
                          <Text as="span" variant="bodyMd">
                            To see all reviews, add new reviews, edit reviews, or delete reviews, click the Reviews button.
                          </Text>
                          <div style={{ marginTop: "0.5rem" }}>
                            <Button
                              onClick={() => navigate(`/app/dis_rating_admin?shop=${encodeURIComponent(shop)}`)}
                              variant="primary"
                              disabled={isLoading}
                              style={buttonStyle}
                            >
